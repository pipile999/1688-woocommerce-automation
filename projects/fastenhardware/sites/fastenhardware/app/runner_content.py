...
TYPE_RULES = (
    ...
    ("rivet", ("铆钉",), ["Rivets"]),
    ("anchor", ("锚栓",), ["Anchors"]),
    ("threaded rod", ("牙条",), ["Threaded Rods & Studs"]),
)
...
NAME_GLOSSARY = {"直径":"Diameter", "长度":"Length", "螺距":"Thread pitch", "螺纹":"Thread coverage", "等级":"Grade/Class", "头型":"Head type", "槽型":"Drive type", "表面处理":"Finish/Coating", "标准":"Standard", "颜色": "Color", "规格": "Specification", "尺寸": "Size", "材质": "Material"}
...
def priced_skus(source, approved):
    ...
    result = []
    for position, s in enumerate(source["skus"]):
        ...
        item["source_sku_position"] = position
